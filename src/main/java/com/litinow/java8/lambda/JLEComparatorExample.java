package com.litinow.java8.lambda;
...
public class JLEComparatorExample {
	...
	public static void main(String[] args) {
		...
		for (Person person : listOfPerson) {
			System.out.println(" Person name : " + person.getName() + " Idade: "+ person.getAge());
		}
		...
		listOfPerson.forEach(
				(person) -> System.out.println(" Person name : " + person.getName() + " Idade: "+ person.getAge()));
	}
}
